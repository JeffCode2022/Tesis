...
class PatientViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if self.action == 'list':
            # Para listado, optimizar con select_related para medico_tratante
            return base_queryset.select_related('medico_tratante').order_by('-created_at')
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            # Invalidar cache
            cache.delete_many([key for key in cache._cache.keys() if 'patients_list' in key])
